...
This data package contains the data that powers the chart ["Total daily supply of calories per person"](https://ourworldindata.org/explorers/global-food?hideControls=true&Food=All+food&Metric=Food+available+for+consumption&Per+capita=false&Unit=Kilocalories+per+day&country=OWID_WRL~USA~CHN~IND~BRA~GBR) on the Our World in Data website. It was downloaded on February 11, 2026.
